...
export default function ApplicationsPage() {
  ...
  const renderApplicationCard = (item: JobApplication) => {
    ...
    return <div key={item.id} className={`${styles.applicationRow} ${overdue ? styles.applicationRowOverdue : ''}`}>
      ...
      <div className={styles.applicationActions}>
        ...
        <Button size="small" aria-label={`查看详情 ${item.company}`} onClick={() => openDetail(item)}>详情</Button>
        <Dropdown menu={{
